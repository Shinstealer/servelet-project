...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#input_pw").blur(function () {
			...
			if(pw1 != "" && pw2 != ""){
				if(pw1 == pw2){
					...
					$(this).next().text("비밀번호가 일치하지 않습니다.").css("diplay" ,"block");
					$(this).val("");
					$(this).focus();
		...
		$(document).on("click" ,"#join_confirm" , function () {
			...
			var form =$("#frm_mem"),		
				em_ck = $("#inputemail_ID").val(), 
				pw_ck = $("#inputpw").val(),
				repw_ck = $("#ck_pw").val(),
				name_ck = $("#inputname").val(),
				nickname_ck = $("#input_nick_name").val(),
				phone_ck = $("#inputphone").val();
			
			var id = $.trim(em_ck.val());
			var regId = /^[A-Za-z0-9]$/; 
			
			if(id ==""){
					em_ck.focus();
					em_ck.next().text("필수정보 입니다.").css("display" , "block");
					return false;
			}else if(!regId.test(id)){
				em_ck.focus();
				em_ck.next().text("영문자와 숫자만 입력하세요.").css("display" , "block");
				return false;
			}
					...
					<div class="socialWrap">
						<div class="text_center">
							...
							<p class="join_sns">
								<button type="button" class="btn-social" style>
									<div>
											<img alt="카카오톡 " src="../img/kakao.jpg" id="kakao_icon">
								...
								<div class="form-horizontal">
									<div class="joinPage" id="em_join">
										 <div id="input_email" >
											...
											<input type="email" placeholder="　example@showoff.com" id="inputemail" class="email-control input_join">
								    		<span class="err_check_msg err_check" id="input_err_">E-mail을 입력해주세요</span>
											<select id="sel_mail">
									...
									<div class="joinPage">
											...
											<div id="input_pw">
												<input type="password" placeholder="최소 8자 이상 입력해주세요"
													id="inputpw" class="form-control input_join checkpw">
									    		<span class="err_check_msg err_check">패스워드를 입력해주세요</span>
											</div>
									</div>
									...
									<div class="joinPage">
											...
											<div id="input_rpw">
												<input type="password" placeholder="패스워드를 다시 입력해주세요"
													id="ck_pw" class="form-control input_join checkpw">
									    		<span class="err_check_msg err_check">설정한 패스워드가 다릅니다.</span>
											</div>
									...
									<div class="joinPage">
											...
											<div id="input_name">
												<input type="text" placeholder="반드시 실명을 입력하세요"
													id="inputname" class="form-control input_join">
										    	<span class="err_check_msg err_check">성함을 입력해주세요.</span>
											</div>
									...
									<div class="joinPage">
											...
											<div id="input_name">
												<input type="text" placeholder="ex)스웩" id="input_nick_name"
													class="form-control input_join">
								    			<span class="err_check_msg err_check">닉네임을 입력해주세요</span>
											</div>
									</div>
									...
									<div class="joinPage">
											...
											<div id="input_phone">
												<input type="tel" placeholder="핸드폰 (-)없이 입력하세요"
													id="inputphone"  class="form-control input_join" maxlength="11">
									    		<span class="err_check_msg err_check">연락처를 입력해주세요</span>
											</div>
									</div>
			...
			<div id="footer">
				...
				<div id="address">
					<span> <a href="http://www.naver.com"> <img
							src="../img/Slogo.png" alt="네이버로고" id="addr_logo">
					</a>
