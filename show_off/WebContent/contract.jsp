...
<!--header  -->
 <header>
 	<div id="header" class="div_size">
 	 <h1 id="showoff_logo">
 	  <a href="index.bizpoll" class="s_logo"><img alt="showoff"src="img/Slogo.png" id="contract_logo"></a>
 	 </h1>
 	 <div class="lang">
 ...
 <article class="div_size">
  <div id="container">
   <form action="" id="join_content">
     ...
     <ul id="terms_ul">
     	<li id="terms_ul_li1">
     		<span class="ul_li_span">
     		 <input type="checkbox" id="li1box" class="ckboxs" name="li1box">
     	...
     	<li id="terms_ul_li2">
     		<span class="ul_li_span">
     		 <input type="checkbox" id="li2box" class="ckboxs" name="li2box">
     	...
     	<li id="terms_ul_li3">
     		<span class="ul_li_span">
     		 <input type="checkbox" id="li3box" class="ckboxs" name="li3box">
     	...
     	<li id="terms_ul_li4">
     		<span class="ul_li_span">
     		 <input type="checkbox" id="li4box" class="ckboxs" name="li4box">
    ...
    <div id="err_check">
    	<span id="err_check_msg">이용약관에 대한 안내를 모두 동의해주세요.</span>
    </div>
