...
$(document).ready(function() {
	...
	$("#login_btn").on("click", function() {
		//alert("경고1");
		var val1 = $("#loginEmail").val();
		var val2 = $("#loginPw").val();
			...
			<span id="close_btn"><i class="fas fa-times"></i></span>
				<h1>
					<a href="#" id="showoff_logo" class="link_logo" >
						<img alt="logo" class="logo_showoff" height="25" src="img/Slogo.png"width="57">
				...
				<div id="main">
					<article id="mArticle">
						...
						<div class="login_inp" id="login_Email">
							<input id="loginEmail" name="loginEmail" type="text" class="inp_login inp_email" placeholder="ID">
						</div>	
						<!--password  -->
						<div class="login_inp" id="login_PW">
							<input id="loginPw" name="loginPw" type="password" class="inp_login inp_pw" placeholder="비밀번호(8~32자리)">
						</div>
						<div class="set_login">
							...
							<span id="err_check">아이디와 비밀번호를 입력해주세요</span>
							<button id="login_btn" class="btn_login submit btn_disabled">
							로그인
							</button>
							<div class="info_user">
								<div class="join_user">
									<a href="join.bizpoll" id="signup">회원가입</a>
									<ul class="list_user">
										<li>
											<a href="#">계정 찾기</a>
